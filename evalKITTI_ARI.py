...
parser.add_argument('--ckpt_path', default='/home/users/skara/check_release/checkpoints/DIODKITTI_100.ckpt', type=str, help='pre-trained model path' )
