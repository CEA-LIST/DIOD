...
from torchvision.transforms import Compose, InterpolationMode, RandomResizedCrop, RandomHorizontalFlip, Resize
...
class ResizeSample(Resize):
    def __init__(self, size: int | list[int] | None = None, interpolation=F.InterpolationMode.BILINEAR) -> None:
